...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activer pour trier la colonne par ordre croissant",sSortDescending:": activer pour trier la colonne par ordre decroissant"},oPaginate:{sFirst:"«",sLast:"»",sNext:">",sPrevious:"<"},sEmptyTable:"Aucune donnée ne correspond aux critères recherchés",sInfo:"Affichage de _START_ à _END_ sur _TOTAL_ enregistrements",sInfoEmpty:"Affichage null",sInfoFiltered:"(filtre sur un total de _MAX_ enregistrements)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Afficher _MENU_ enregistrements",sLoadingRecords:"Chargement...",sProcessing:"Traitement...",sSearch:"Rechercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucune correspondance trouvée"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};E(u.defaults);u.defaults.column={aDataSort:null,
